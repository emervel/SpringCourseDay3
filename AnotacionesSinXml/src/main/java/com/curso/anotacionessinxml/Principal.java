...
public class Principal {
    ...
    private void init() {
        /* Ya no se usa el classpathaplicationcontext si no que usamos una nueva clase que es una 
        implementación de una interfaz (ApplicationContext) que carga las clases de configuracion */
